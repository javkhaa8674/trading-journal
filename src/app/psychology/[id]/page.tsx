...
export default function EditPsychologyPage() {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      if (entryData) {
        setFormData({
          date: entryData.date.slice(0, 10),
          mood: entryData.mood,
          confidence_level: entryData.confidence_level,
          lesson_learned: entryData.lesson_learned || "",
          notes: entryData.notes || "",
          trades_count: entryData.trades_count || 0,
          winning_trades: entryData.winning_trades || 0,
          losing_trades: entryData.losing_trades || 0,
          profit_loss: entryData.profit_loss || 0,
        });
        setSelectedMistakes(entryData.mistakes || []);
      }
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl sm:text-2xl font-bold">
              ✏️ Тэмдэглэл засварлах
            </h1>
            <p className="text-xs sm:text-sm text-gray-500">
              Арилжааны сэтгэл зүйн тэмдэглэл засварлах
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-lg border bg-white p-4 sm:p-6 dark:bg-gray-900">
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="md:col-span-2">
              <label className="block text-sm font-medium mb-1">Сургамж</label>
              <textarea
